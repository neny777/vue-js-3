...
const isEditMode = ref(!!route.params.colaboradorId);
// Validation schema
const schema = yup.object({
  ...
  ctps: yup.string().nullable().optional().max(15, 'Máximo de 15 caracteres'),
});
...
const hasChanges = (newValues) => {
  return JSON.stringify(newValues) !== JSON.stringify(state.colaborador);
};
onMounted(async () => {
  state.isProcessing = true;
  if (isEditMode.value) {
    try {
      const { data } = await axiosInstance.get(`/colaboradores/${route.params.colaboradorId}`);
      console.log(data);
      state.colaborador = data;
      state.colaborador = {
        ...state.colaborador,
        nascimento: formatToBrDate(state.colaborador.nascimento),
      };
    } catch (error) {
      showToast("erro", "Erro ao carregar colaborador: ", error);
    }
  }
            ...
            <div class="card"> <!--begin::Header-->
              <div class="card-header">
                <div class="card-title">
                  <h5>{{ isEditMode ? 'Editar Colaborador' : 'Novo Colaborador' }}</h5>
                </div>
              ...
              <div v-else>
                <Form @submit="onSubmit" :validation-schema="schema" :initial-values="state.colaborador"
                    ...
                    <div class="row g-2">
                      ...
                      <div class="col-md-6 px-5">
                        <div class="row"> <label for="email" class="col-form-label col-lg-4">Email</label>
                          <div class="col-lg-8">
                            <Field as="input" id="email" name="email" type="email" class="form-control"
                              maxlength="70" />
                      ...
                      <div class="col-md-6 px-5">
                        <div class="row"> <label for="numero" class="col-form-label col-lg-4">Número</label>
                          <div class="col-lg-8">
                            <Field as="input" id="numero" name="numero" type="text" class="form-control"
                              maxlength="6" />
                      ...
                      <div class="col-md-6 px-5">
                        <div class="row"> <label for="bairro" class="col-form-label col-lg-4">Bairro</label>
                          <div class="col-lg-8">
                            <Field as="input" id="bairro" name="bairro" type="text" class="form-control"
                              maxlength="60" />
                      ...
                      <!--begin::Col-->
                      <div class="col-md-6 px-5">
                        <div class="row"> <label for="cpf" class="col-form-label col-lg-4">CPF</label>
                          <div class="col-lg-8">
                            <Field as="input" id="cpf" name="cpf" type="text" class="form-control" maxlength="14"
                              v-mask="'###.###.###-##'" />
                      ...
                      <!--begin::Col-->
                      <div class="col-md-6 px-5">
                        <div class="row"> <label for="rg" class="col-form-label col-lg-4">RG</label>
                          <div class="col-lg-8">
                            <Field as="input" id="rg" name="rg" type="text" class="form-control" maxlength="14" />
                            <ErrorMessage name="rg" class="text-danger" />
                          </div>
                        </div>
                      </div> <!--end::Col-->
                      <!--begin::Col-->
                      <div class="col-md-6 px-5">
                        <div class="row"> <label for="sexo" class="col-form-label col-lg-4">Sexo</label>
                          <div class="col-lg-8">
                            <Field as="select" id="sexo" name="sexo" class="form-select" aria-label="Sexo">
                              <option value="" disabled selected></option>
                              <option value="M">MASCULINO</option>
                              <option value="F">FEMININO</option>
                            </Field>
                            <ErrorMessage name="sexo" class="text-danger" />
                          </div>
                        </div>
                      </div><!--end::Col-->
                      <!--begin::Col-->
                      <div class="col-md-6 px-5">
                        <div class="row"> <label for="nascimento" class="col-form-label col-lg-4">Nascimento</label>
                          <div class="col-lg-8">
                            <Field as="input" id="nascimento" name="nascimento" type="text" class="form-control"
                              maxlength="60" v-mask="'##/##/####'" />
                            <ErrorMessage name="nascimento" class="text-danger" />
                          </div>
                        </div>
                      </div> <!--end::Col-->
                      <!--begin::Col-->
                      <div class="col-md-6 px-5">
                        <div class="row"> <label for="ctps" class="col-form-label col-lg-4">CTPS</label>
                          <div class="col-lg-8">
                            <Field as="input" id="ctps" name="ctps" type="text" class="form-control" />
                            <ErrorMessage name="ctps" class="text-danger" />
                          </div>
                        </div>
                      </div> <!--end::Col-->
                    </div> <!--end::Row-->
                  ...
                  <div class="card-footer">
                    <div class="row m-2">
                      <div class="col-lg-6 text-center">
                        <RouterLink to="/colaboradores" class="nav-link"><button type="button"
